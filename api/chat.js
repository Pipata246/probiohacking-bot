...
7. НЕ ДОБАВЛЯЙ рекомендации пройти диагностику или загрузить анализы — пользователь уже это сделал!
8. НЕ пиши "Чтобы ответ был точнее" или подобные фразы — у тебя уже есть все данные!`;
    }
