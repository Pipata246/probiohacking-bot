...
function addWelcomeMessage() {
  ...
  // Добавляем старые кнопки "Мои анализы" и "Диагностика" на всю ширину
  const actionsDiv = document.createElement('div');
  actionsDiv.className = 'ai-actions-full-width';
  ...
  // Добавляем кнопки в chatMessages (не в контейнер!)
